<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Form.aspx.cs" Inherits="LoginUserRegistration.Form" %>
  ...
  <head>
    ...
    <link rel="stylesheet" href="./content/form.css" />
     <script src='<%=ResolveClientUrl("~/Scripts/form.js") %>' type="text/javascript"></script>
      <script src='<%=ResolveClientUrl("~/Scripts/files.js") %>' type="text/javascript"></script>
