<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="UserManagement.LoginPage" %>
...
<body>
    <form runat="server" id="form1">
        ...
        <asp:Button type="button" ID="loginBtn" runat="server" Text="Login" ClientIDMode="Static" />
    </form>
</body>
</html>