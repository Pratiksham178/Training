...
{
    public partial class FormPage1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.Params["userId"] != null)
                {
                    ...
                    var userrole = dbcontext.userrolerelations.Where((i) => i.userID == specificUserId).Select(i => i.roleID).ToList();
        ...
        protected void DeleteUser(object sender, EventArgs e)
        {
            ...
            using (var dbcontext = new ProfileEntities())
            {
                ...
                dbcontext.language_table.RemoveRange(deletelanguages);
                var userroles = dbcontext.userrolerelations.Where((i) => i.userID == specificUserId).ToList();
                dbcontext.userrolerelations.RemoveRange(userroles);
